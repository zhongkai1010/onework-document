# 第二篇、ECMAScript 6 笔记
## 一、let 和 const 命令
**let：****let**命令，用来声明变量。它的用法类似于`var`，但是所声明的变量，只在`let`命令所在的代码块内有效。
...
* 可以把一些 不需要对外操作和访问 的属性使用Symbol来定义
* 保证常量的值是唯一性 保证常量与变量不相等
* 为类创建私有属性方法 控制访问
...
ECMAScript 浏览器支持：[https://kangax.github.io/compat-table/es6/](https://kangax.github.io/compat-table/es6/)

MDN：[https://developer.mozilla.org/zh-CN/docs/Learn/JavaScript](https://developer.mozilla.org/zh-CN/docs/Learn/JavaScript)